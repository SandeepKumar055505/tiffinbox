...
const TiffinBloom = () => (
  <div className="relative py-16 flex flex-col items-center justify-center text-center px-4">
    <div className="relative w-56 sm:w-64 mx-auto mb-8">
      <div className="w-full bg-white rounded-3xl shadow-xl border border-slate-100 p-8 space-y-4">
        <div className="space-y-2">
          <span className="text-[9px] font-black uppercase tracking-widest text-amber-600 block">🌅 Subah ka Nashta</span>
          <span className="text-slate-900 font-heritage font-black text-base italic">Poha & Adrak Chai</span>
        </div>
        <div className="border-t border-slate-50 pt-3 space-y-2">
          <span className="text-[9px] font-black uppercase tracking-widest text-amber-600 block">☀️ Dopahar ki Thaali</span>
          <span className="text-slate-900 font-heritage font-black text-base italic">Rajma Chawal & Raita</span>
        </div>
        <div className="border-t border-slate-50 pt-3 space-y-2">
          <span className="text-[9px] font-black uppercase tracking-widest text-amber-600 block">🌙 Raat ka Sukoon</span>
          <span className="text-slate-900 font-heritage font-black text-base italic">Dal Tadka & Missi Roti</span>
        </div>
      </div>
    </div>
    <p className="text-xl sm:text-2xl font-heritage font-black italic text-slate-800">Teen waqt ki thaali.</p>
    <p className="text-sm text-slate-400 mt-1">Subah se raat tak — ghar ka swaad, roz.</p>
  </div>
);
    ...
    <div className="min-h-screen bg-culinary-soul selection:bg-amber-100 selection:text-amber-800 overflow-x-hidden font-zenith scroll-smooth text-slate-800">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-[60] px-4 sm:px-6 py-3 flex justify-between items-center mx-2 sm:mx-3 mt-2 sm:mt-3 rounded-2xl sm:rounded-full transition-all duration-500 ${scrolled ? 'glass-prismatic shadow-warm' : 'bg-white/0'}`}>
        ...
        <div className="hidden md:flex items-center gap-6 lg:gap-8">
          ...
          <button onClick={() => scrollTo('start')} className="px-5 py-2 bg-amber-500 text-white rounded-full text-[10px] font-black uppercase tracking-widest hover:bg-amber-600 active:scale-95 transition-all shadow-md shadow-amber-500/20">Start →</button>
        </div>
        <button onClick={() => setMenuOpen(!menuOpen)} className="md:hidden w-9 h-9 flex items-center justify-center rounded-xl bg-white/60 border border-slate-100">{menuOpen ? <X size={16} /> : <Menu size={16} />}</button>
      </nav>

      <>
        {menuOpen && (
          <div className="fixed inset-x-0 top-[60px] z-[55] mx-3 bg-white rounded-2xl shadow-xl p-6 space-y-4 md:hidden border border-slate-100">
            {[{ l: "Our Story", id: "our-story" }, { l: "Menu", id: "weekly-menu" }, { l: "How It Works", id: "how-it-works" }, { l: "Reviews", id: "reviews" }].map(n => (
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center pt-20 sm:pt-24 pb-8 sm:pb-16 px-4 sm:px-6 text-center overflow-hidden">
        ...
        <div className="relative z-10 space-y-6 sm:space-y-8 max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 rounded-full border border-amber-500/15 bg-white/60 backdrop-blur-md shadow-sm badge-shine">
          ...
          <div className="space-y-3 sm:space-y-4">
            <p className="text-xs sm:text-sm text-slate-400 font-heritage italic">
            ...
            <h1 className="text-[2.2rem] sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tight leading-[0.9] font-heritage">
              <span className="block italic text-slate-900">Woh Swaad Wapas Lao.</span>
              <span className="block text-amber-500 not-italic uppercase mt-1 text-[1.8rem] sm:text-4xl md:text-5xl lg:text-6xl">Roz. Har Bite Mein.</span>
            </h1>
            <p className="max-w-md mx-auto text-xs sm:text-sm md:text-base text-slate-500 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-5 pt-2 sm:pt-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 pt-4 sm:pt-8 text-[10px] sm:text-xs">
      ...
      <section className="px-4 sm:px-6 pb-8 sm:pb-16 -mt-4 sm:-mt-8">
        <div className="max-w-5xl mx-auto">
          <div className="relative rounded-[1.5rem] sm:rounded-[2.5rem] overflow-hidden shadow-[0_20px_60px_-15px_rgba(0,0,0,0.12)] border-2 border-white ring-1 ring-black/5 group">
      ...
      <section className="py-12 sm:py-20 px-4 sm:px-6 bg-white">
        <div className="max-w-3xl mx-auto space-y-8 sm:space-y-12">
          ...
          <div className="space-y-3 sm:space-y-4">
            {PAIN_POINTS.map((p, i) => (
              <div key={i} className="flex items-start gap-3 sm:gap-4 p-4 sm:p-5 bg-red-50/40 border border-red-100/50 rounded-xl sm:rounded-2xl"
              >
        ...
        <div className="max-w-5xl mx-auto space-y-10 sm:space-y-14">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
            {[
              ...
              return (
                <div key={i} className="bg-white rounded-2xl sm:rounded-3xl p-5 sm:p-6 space-y-3 group border border-slate-100 hover:border-amber-500/20 hover:shadow-warm transition-all cursor-default"
                >
      ...
      <section id="how-it-works" className="py-16 sm:py-24 px-4 sm:px-6 bg-slate-50">
        <div className="max-w-5xl mx-auto space-y-10 sm:space-y-14">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
            {STEPS.map((s, i) => (
              <div key={i} className="bg-white rounded-2xl sm:rounded-3xl overflow-hidden border border-slate-100 hover:border-amber-500/20 hover:shadow-warm transition-all group"
              >
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-8 sm:space-y-12">
          ...
          <div className="flex gap-4 sm:gap-5 overflow-x-auto pb-4 sm:pb-8 no-scrollbar snap-x snap-mandatory -mx-2 px-2">
            {CHEF_DATA.map((chef, i) => (
              <div key={i} className="flex-shrink-0 w-56 sm:w-64 md:w-72 snap-center">
        ...
        return (
          <section className="py-14 sm:py-20 px-4 sm:px-6 bg-slate-50">
            <div className="max-w-3xl mx-auto space-y-8 sm:space-y-12">
              ...
              <div className="bg-emerald-50 rounded-2xl p-5 sm:p-6 border border-emerald-100/50 text-center space-y-1">
        ...
        <div className="max-w-4xl mx-auto space-y-8 sm:space-y-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 sm:gap-4">
            {NEIGHBORHOODS.map((n, i) => (
              <div key={i} className="bg-white rounded-xl sm:rounded-2xl p-3.5 sm:p-4 border border-slate-100 hover:border-amber-500/20 hover:shadow-warm transition-all text-center space-y-1.5 group cursor-default"
              >
        ...
        <div className="max-w-3xl mx-auto space-y-8 sm:space-y-12">
          ...
          <div className="space-y-5 sm:space-y-6">
            {ORIGIN_STORY.paragraphs.map((p, i) => (
              <p key={i} className="text-sm sm:text-base md:text-lg text-slate-600 leading-relaxed font-heritage italic"
              >
                {p}
              </p>
            ))}
          </div>
          <div className="bg-amber-50/50 rounded-2xl sm:rounded-3xl p-6 sm:p-8 border border-amber-100/50 text-center space-y-3">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-10 items-start">
            <div className="space-y-3 sm:space-y-4">
              {COVENANT_LAYERS.map((l, i) => (
                <div key={i} className="flex gap-3 sm:gap-4 group cursor-default bg-white rounded-2xl p-4 sm:p-5 border border-slate-100 hover:border-amber-500/15 hover:shadow-warm transition-all">
      ...
      {/* Loader */}
      <>{loading && (<div className="fixed inset-0 z-[1000] bg-white/95 backdrop-blur-3xl flex items-center justify-center"><div className="flex flex-col items-center gap-5"><div className="relative"><div className="w-14 h-14 border-[3px] border-amber-100 border-t-amber-500 rounded-full animate-spin" /><div className="absolute inset-0 flex items-center justify-center text-xl">🍱</div></div><p className="text-lg font-heritage font-black italic text-slate-900 tracking-tighter">Tiffin pack ho raha hai...</p></div></div>)}</>
    </div>
  );
}
